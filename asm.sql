...
VALUES (123345, '2024/07/25', 618500.00, N'12 Trần Quang Diệu', N'Giao hàng thành công'),
       ...
       (789910, '2024/06/15', 500000.00, N'21 Đông Các', N'Hủy đơn'),
       (910101, '2024/06/12', 250000.00, N'45 Minh Khai', N'Giao hàng thành công')
GO
